...
def generate_launch_description():
    ...
    parameter_specs = [
        ...
        ("lane_forward_pwm", 1650, int, "Maximum forward PWM during lane and waypoint motion."),
        ("lane_forward_slow_pwm", 1532, int, "Minimum forward PWM during lane interception and waypoint slowdown."),
        ...
        ("lane_transfer_forward_pwm", 1600, int, "Maximum forward PWM while moving between adjacent lanes."),
