...
echo "  ln -sfn $(cd "${SCRIPT_DIR}/.." && pwd) ~/auv_ws/src/auv_vision_control"
echo "  cd ~/auv_ws && colcon build --packages-select auv_vision_control --symlink-install"
echo "  source ~/auv_ws/install/setup.bash"
echo "  ros2 launch auv_vision_control vision_control.launch.py"
